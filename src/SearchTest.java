...
public class SearchTest {
    public static void main(String[] args) {
        ...
        System.out.println(Search.linearSearchTF(numArray, 38));
        System.out.println(Search.linearSearchTF(numArray, 9));
        System.out.println(Search.linearSearchTF(numArray, 5));
